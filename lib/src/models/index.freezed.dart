...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthState auth, ProductsState products, Set<String> pendingActions});
...
abstract class AppState$ implements AppState {
  const factory AppState$({final AuthState auth, final ProductsState products, final Set<String> pendingActions}) =
      _$AppState$;
